...
export default function Layout({ children, currentPageName }) {
  ...
  const navigation = [
    ...
    { name: 'Send SMS', icon: MessageSquare, page: 'SendSMS' },
    { name: 'Send Email', icon: Mail, page: 'SendEmail' },
  ...
  const adminNavigation = [
    { name: 'Users', icon: Shield, page: 'AdminUsers' },
    { name: 'Sender Numbers', icon: Phone, page: 'AdminSenderNumbers' },
    { name: 'Message Logs', icon: MessageSquare, page: 'AdminMessageLogs' },
    { name: 'System Settings', icon: Settings, page: 'AdminSettings' },
  ];
