  ...
  const handleSend = async () => {
    ...
    try {
      ...
      if (recipientType === 'single') {
        ...
        recipients = groupData.members.filter(m => m.email);
      }
      ...
      // Store messages (actual email sending would require email service integration)
      ...
      setResult({
        success: true,
        message: `Successfully ${scheduleDate ? 'scheduled' : 'queued'} ${recipients.length} email(s)!`
      });
